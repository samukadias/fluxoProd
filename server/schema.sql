...
CREATE TABLE IF NOT EXISTS demands (
    ...
    -- contract_id added later if needed or in definition if strictly ordered, but index.js has it inside CREATE.
...
CREATE TABLE IF NOT EXISTS status_history (
    id SERIAL PRIMARY KEY,
    demand_id INTEGER, -- Removed REFERENCES demands(id) to avoid circular dependency issues if created out of order, or keep it if demands exists.
...
-- Fix Demands FK
ALTER TABLE demands ADD COLUMN IF NOT EXISTS contract_id INTEGER REFERENCES contracts(id);
...
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS analista_responsavel VARCHAR(255);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS cliente VARCHAR(255);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS grupo_cliente VARCHAR(255);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS contrato VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS termo VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS status_vencimento VARCHAR(50);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS data_inicio_efetividade TIMESTAMP;
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS data_fim_efetividade TIMESTAMP;
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS data_limite_andamento TIMESTAMP;
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS valor_contrato DECIMAL(15, 2);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS valor_faturado DECIMAL(15, 2);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS valor_cancelado DECIMAL(15, 2);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS valor_a_faturar DECIMAL(15, 2);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS valor_novo_contrato DECIMAL(15, 2);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS tipo_tratativa VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS tipo_aditamento VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS etapa TEXT;
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS objeto TEXT;
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS secao_responsavel VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS observacao TEXT;
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS numero_processo_sei_nosso VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS numero_processo_sei_cliente VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS contrato_cliente VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS contrato_anterior VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS numero_pnpp_crm VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS sei VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS contrato_novo VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS termo_novo VARCHAR(100);
...
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS responsible_analyst VARCHAR(255);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS pd_number VARCHAR(50);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS sei_process_number VARCHAR(50);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS sei_send_area VARCHAR(100);
ALTER TABLE contracts ADD COLUMN IF NOT EXISTS esps JSONB DEFAULT '[]';
